  ...
  <div class="px-4 sm:px-6 lg:px-8">
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto">
        ...
        <p class="mt-2 text-sm text-gray-700">Lista de empresas cadastradas no sistema.</p>
      </div>
    </div>
            ...
            <table class="min-w-full divide-y divide-gray-300 relative">
              <thead class="bg-gray-50 sticky top-0">
                <tr>
                  ...
                  <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Quantidade de Colabodores</th>
              ...
              <tbody class="divide-y divide-gray-200 bg-white">
                <tr v-for="company in companies" :key="company.id">
                  ...
                  <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500 flex flex-col overflow-y-auto max-h-14">{{ company.category }}</td>
                </tr>
              </tbody>
            </table>
          </div>
